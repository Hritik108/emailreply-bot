...
client = OpenAI(api_key="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")
...
def create_email(user_prompt):
    ...
    system_prompt = """
    you are a restuarnt owner providing replies by reading reviews of your customer
    """
